...
import org.apache.spark.util.ExternalSizeEstimator
 ...
 */
private[spark] trait ExternalSizeTracker extends Logging {

  import ExternalSizeTracker._
  ...
  private def takeSample(): Unit = {
    samples.enqueue(Sample(ExternalSizeEstimator.estimate(this), numUpdates))
...
private object ExternalSizeTracker {
